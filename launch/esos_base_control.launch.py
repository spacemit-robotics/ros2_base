...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('deadzone_epsilon', default_value='0.001'),
        DeclareLaunchArgument('min_linear_velocity', default_value='0.04'),
        DeclareLaunchArgument('min_angular_velocity', default_value='0.41'),
